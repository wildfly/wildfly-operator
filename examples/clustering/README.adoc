...
[source,shell]
----
$ oc apply -f examples/clustering/crds/clusterbench.yaml
...
[source,shell]
----
$ oc describe wildflyserver clusterbench
Name:         clusterbench
Namespace:    myproject
Labels:       <none>
...
[source,shell]
----
$ oc get service clusterbench-loadbalancer
...
[source,shell]
----
$ oc get route clusterbench-loadbalancer --template='{{ .spec.host }}'
...
[source,shell]
----
$ oc edit wildflyserver clusterbench
