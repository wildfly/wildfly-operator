...
| `volumes`| Additional volumes to be created in the server Pod | []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#volume-v1-core[corev1.Volume] | false
| `volumeMounts`| Additional volume mounts for the container | []https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#volumemount-v1-core[corev1.VolumeMount] | false
|=======================
