...
func Create(w *wildflyv1alpha2.WildFlyServer, client client.Client, scheme *runtime.Scheme, objectDefinition runtime.Object) error {
...
func Get(w *wildflyv1alpha2.WildFlyServer, namespacedName types.NamespacedName, client client.Client, objectDefinition runtime.Object) error {
...
func Update(w *wildflyv1alpha2.WildFlyServer, client client.Client, objectDefinition runtime.Object) error {
	logger := logWithValues(w, objectDefinition)
...
func UpdateStatus(w *wildflyv1alpha2.WildFlyServer, client client.Client, objectDefinition runtime.Object) error {
	logger := logWithValues(w, objectDefinition)
...
func UpdateWildFlyServerStatus(w *wildflyv1alpha2.WildFlyServer, client client.Client) error {
...
func Delete(w *wildflyv1alpha2.WildFlyServer, client client.Client, objectDefinition runtime.Object) error {
	logger := logWithValues(w, objectDefinition)
...
func logWithValues(w *wildflyv1alpha2.WildFlyServer, objectDefinition runtime.Object) logr.Logger {
